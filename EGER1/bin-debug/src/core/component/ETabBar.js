...
var ETabBar = (function (_super) {
    ...
    */
    ...
    var __egretProto__ = ETabBar.prototype;
    __egretProto__.init = function (context, backFun, descStrArr, fontSize, cartoonType, assetsName) {
        if (backFun === void 0) { backFun = null; }
        if (descStrArr === void 0) { descStrArr = []; }
        if (fontSize === void 0) { fontSize = 30; }
        if (cartoonType === void 0) { cartoonType = 1; }
    ...
    __egretProto__.onSelectBack = function (data) {
        this.retset();
    ...
    //设置选中的index
    __egretProto__.setSelectedIndex = function (index) {
    ...
    __egretProto__.retset = function () {
